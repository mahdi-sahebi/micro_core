...
typedef void (*initiator_fn)(void* const, uint64_t);
typedef uint32_t (*getter_fn)(const void* const);
...
{
  typedef void (*getter_fn)(void* const, uint32_t);
  const getter_fn getter[] = {
