...
static int create_8()
{
  const mc_buffer buffer = mc_buffer_char(Buffer, SIZE_08_BIT);
...
{
  const mc_buffer buffer = mc_buffer_char(Buffer, SIZE_16_BIT);
...
{
  const mc_buffer buffer = mc_buffer_char(Buffer, SIZE_32_BIT);
...
{
  const mc_buffer buffer = mc_buffer_char(NULL, SIZE_08_BIT);
